...
export const CATEGORY_RULES: readonly CategoryRule[] = [
  {
    slug: "adult",
    titleKeywords: ["adult", "18 plus", "erotic", "sex toy", "dildo", "vibrator", "lubricant", "joydivision", "princess monster", "სექს", "ვიბრატორი", "დილდო", "ლუბრიკანტი"],
  ...
  },
  {
    ...
    negativeKeywords: ["dash cam", "glass pro", "screen protector", "tempered glass", "camera protector", "lens protector", "vacuum", "vacuum cleaner", "robot vacuum"],
    titleWeight: 94,
  },
  {
    slug: "audio",
  ...
  },
  {
    ...
    contextKeywords: ["smart device", "smart home", "security sensor", "monitoringi", "chkviani"],
    shopKeywords: ["smart-motsyobilobebi", "smart-satvaleebi", "chkviani-sensorebi", "grafikuli-tabebi"],
    titleWeight: 84,
  },
  {
    slug: "clothing",
    ...
    negativeKeywords: ["scooter", "kickscooter", "electric scooter", "travelite", "travel bag", "სამგზავრო ჩანთა", "ჩემოდნის"],
    contextKeywords: ["clothing", "fashion", "jewelry", "accessories"],
    shopKeywords: ["clothing", "fashion", "jewelry", "samkauli", "tansatsmeli"],
    titleWeight: 82,
  },
  {
    slug: "tools",
    ...
    contextKeywords: ["tools", "hardware"],
    shopKeywords: ["tools", "hardware"],
    titleWeight: 84,
  },
  {
    slug: "furniture",
  ...
  {
    slug: "home-garden",
    titleKeywords: ["scent diffuser", "smart scent diffuser", "rainbow batteries", "aa batteries", "aaa batteries", "aaa4bkp", "cr2 battery", "batteries", "ელემენტი"],
    titleWeight: 92,
  },
  {
    slug: "home-garden",
    titleKeywords: ["garden tool", "storage box", "lighting", "lamp", "home decor", "cleaning tool", "organizer", "extension cord", "smart wall switch", "broadlink", "garden hose", "soap dispenser", "sauna aroma", "pool", "decorative figure", "wall decoration", "vase", "candle", "lighter", "keychain", "laundry capsule", "synergetic", "წყლის მილი", "სარწყავი შლანგი", "საპნის დისპენსერი", "ელექტრო ხრახნდამჭერი", "ტორსული ხერხი", "დეკორატიული ღობე", "ხელსაწყო", "ბაღი", "განათება", "დეკორი", "ორგანიზერი", "საუნის არომატი", "ლარნაკი", "სანთელი", "კედლის დეკორაცია", "დეკორატიული ფიგურა", "გასაბერი აუზი", "საახალწლო", "სანთებელა", "ბრელოკი", "სარეცხი კაფსულები"],
  ...
  {
    slug: "sport",
    titleKeywords: ["sport", "fitness", "bicycle", "scooter", "kickscooter", "scooter bag", "ekinekt", "helmet", "commuter helmet", "riding helmet", "rear-view mirror", "travelite", "travel bag", "knee support", "სავარჯიშო რეზინი", "სპორტ", "ფიტნეს", "ჩაფხუტი", "ჩემოდნის", "სამგზავრო ჩანთა", "სამუხლე"],
    titleWeight: 72,
  },
  {
    slug: "sport",
  ...
  {
    slug: "kids",
    titleKeywords: ["kids", "baby", "child", "toy", "stroller", "lego", "hasbro", "revell", "magic blocks", "carter's", "funko pop", "ფაზლი", "მძივების ნაკრები", "რბილი ბურთი", "ტყუპების ეტლი", "საწოლ-მანეჟი", "სამაგიდო თამაში", "საბავშვო", "საბაშვო", "ბავშვ", "სათამაშო", "კონსტრუქტორი", "გოგოს"],
    titleWeight: 72,
  },
  {
    slug: "pets",
    titleKeywords: ["petsuper", "pet feeder", "pet water", "pet dispenser", "pet supplies", "pet leash", "dog leash", "cat leash", "leash nylon", "dog waste", "petsfamily", "nobby", "ძაღლის", "კატის", "კატისთვის", "ცხოველ"],
    titleWeight: 90,
  },
  {
    slug: "books-stationery",
    titleKeywords: ["book", "stationery", "notebook", "marker", "pencil", "paper", "paintings", "sculptures", "drawings", "rhodia", "ფლომასტერ", "ფერადი ფანქარ", "სახაზავი", "წიგნ", "საკანცელარიო", "ფურც", "ბლოკნოტი", "ირენ ადლერი", "შერლოკი"],
    titleWeight: 78,
  },
];
