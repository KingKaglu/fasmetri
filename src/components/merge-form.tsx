...
export function MergeForm({ products }: { products: ProductView[] }) {
  ...
  return (
    <form onSubmit={merge} className="grid gap-3 rounded-[1.15rem] border border-[#e4e4e7] bg-white/92 p-4 shadow-[0_12px_30px_rgba(10,10,10,0.07)]">
      <div>
      ...
      <button className="h-11 rounded-2xl bg-[#0a0a0a] text-sm font-black text-white hover:bg-black">გაერთიანება</button>
